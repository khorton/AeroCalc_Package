...
class Test_eas2drag(unittest.TestCase):

    def test_01(self):
        """
        Example from CAFE Foundation Aircraft Performance Report for RV-6A:
        http://cafefoundation.org/v2/pdf_apr/RV-6A%20Final%20APR.pdf.
        
        Note: the Cd0 value was fudged slightly to make the calculation match.
        """
        Value = cd.eas2drag(
            106,
            1650,
